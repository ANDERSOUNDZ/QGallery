...
$("#subirFoto").change(function(){
	...
	if(Number(imagenSize) < 2000000 && imagenType == "image/jpeg" || imagenType == "image/png"){
		...
		$.ajax({
			url:"vista/ajax/gestorArticulos.php",
			method: "POST",
			data: datos,
			cache: false,
			contentType: false,
			...
			beforeSend: function(){
					...
					$("#arrastreImagenArticulo").before('<img src="vista/images/status.gif" id="status">');
			...
			if(Number(imagenSize) < 2000000 && imagenType == "image/jpeg" || imagenType == "image/png"){
				...
				$.ajax({
						...
						beforeSend: function(){
							...
							$("#nuevaFoto").html('<img src="vista/images/status.gif" style="width:15%" id="status2">');
