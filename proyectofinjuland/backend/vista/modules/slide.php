...
<p><span class="fa fa-arrow-down"></span>  Arrastra aquí tu imagen (tamaño recomendado: 1600px * 700px y peso recomendado: 2MB)</p>
...
<!-- <div id="slide" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
       <li>
       	<img src="vista/images/slide/slide01.jpg">
       ...
       <li>
       	<img src="vista/images/slide/slide02.jpg"> 	
       	<div class="slideCaption">
       		<h3>Lorem Ipsum</h3>
	   		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
       	</div>
       ...
       <li>
       	<img src="vista/images/slide/slide03.jpg">
       	<div class="slideCaption">
       		<h3>Lorem Ipsum</h3>
	   		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
       	</div>
       ...
       <li>
       	<img src="vista/images/slide/slide04.jpg">
       	<div class="slideCaption">
       		<h3>Lorem Ipsum</h3>
	   		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
       	</div>
